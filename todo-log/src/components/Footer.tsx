...
const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className="w-full border-t border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center text-sm space-y-4 sm:space-y-0">
